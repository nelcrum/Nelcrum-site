...
(function () {
  ...
  function showFull(d, fils, givingIsEst) {
    ...
    var buyHref = window.ncBuyLink ? window.ncBuyLink('funder-report-pdf') : 'contact.html?buy=funder-report-pdf';
    h += '<div style="display:flex; flex-wrap:wrap; align-items:center; gap:16px 24px; background:#fff; border:1px solid #E2D7C4; border-radius:4px; padding:24px 28px; margin-top:16px;"><div style="flex:1; min-width:260px;"><div style="font-family:Archivo,sans-serif; font-size:10.5px; font-weight:700; letter-spacing:.14em; text-transform:uppercase; color:#C98A2B; margin-bottom:6px;">Take this report with you</div><div style="font-family:Archivo,sans-serif; font-weight:700; font-size:18px; margin-bottom:4px;">Full Report PDF \u2014 $39</div><div style="font-size:13.5px; line-height:1.55; color:#57534A;">An analyst-checked PDF of this funder: multi-year giving tables, peer comparison, and officers as filed. Delivered to your email within one business day.</div></div><a href="' + buyHref + '" style="text-decoration:none; background:#17140F; color:#fff; padding:13px 22px; border-radius:4px; font-family:Archivo,sans-serif; font-weight:700; font-size:14.5px; white-space:nowrap;">Buy the PDF &#8594;</a></div>';
