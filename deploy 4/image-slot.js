  ...
  class ImageSlot extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this._ro = new ResizeObserver(() => {
        // Defer to the next frame so a re-render triggered by this observation
        // never resizes within the same delivery cycle (which is what trips the
        // benign "ResizeObserver loop completed" console warning).
