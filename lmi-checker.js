/* NELCRUM Solutions — LMI Tract Dashboard
 * Address or GEOID → tract FFIEC income level + LMI flag, trend, county/state context.
      ...
      '<div data-stack style="display:grid;grid-template-columns:1.25fr 1fr;gap:20px;">' +
        ...
        '<div style="background:#fff;border:1px solid #DDDBD2;border-radius:4px;padding:32px;">' +
          '<div style="display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;margin-bottom:18px;">' +
            '<span style="font-family:Archivo,sans-serif;font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#8A857B;">FFIEC income level · 2024 vintage</span>' +
          ...
          '<div style="display:flex;align-items:center;gap:18px;flex-wrap:wrap;">' +
            ...
            '<span style="font-size:13px;font-weight:700;color:' + (b24.lmi ? '#3F7A55' : '#57534A') + ';background:' + (b24.lmi ? '#E6F1E9' : '#EFEEE9') + ';border-radius:4px;padding:7px 14px;">' + (b24.lmi ? 'LMI tract — qualifying geography' : 'Not an LMI tract') + '</span>' +
          '</div>' +
    ...
    $('cc-layers').innerHTML =
      '<div style="margin-top:20px;background:#fff;border:1px solid #DDDBD2;border-radius:4px;padding:26px 28px;">' +
        ...
        '<div data-stack style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px;">' +
          layer(true, 'LMI geography', b24.lmi ? 'Qualifies' : 'Does not qualify', b24.lmi ? 'Activity here can count toward bank community-lending goals.' : 'This tract is ' + b24.label.toLowerCase() + '; CRA credit would need another basis (e.g. LMI individuals served).', b24.lmi) +
    ...
    $('cc-meaning').innerHTML =
      '<div data-stack style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:20px;">' +
        ...
        '<div style="background:#17140F;color:#F5F4F0;border-radius:4px;padding:26px 28px;display:flex;flex-direction:column;gap:14px;justify-content:center;">' +
          ...
          '<p style="font-size:14px;line-height:1.6;color:rgba(245,244,240,.72);margin:0;">We run batch screens, CRA assessment-area analyses, and custom eligibility dashboards for banks and agencies.</p>' +
